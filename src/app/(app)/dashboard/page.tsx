...
export default async function DashboardPage({
  ...
  // Better Auth session only returns base user fields; fetch extended profile
  ...
  // Upcoming bills sorted by dueDay
    ...
    <div className="min-h-screen bg-[#FFFBF5]">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="text-center sm:text-left">
              ...
              <p
                className={[
                  "mt-1 text-5xl font-extrabold tracking-tight",
                  disposablePositive ? "text-white" : "text-yellow-200",
                ].join(" ")}
              >
            ...
            >
              ...
              <p
                className={[
                  ...
                  positive ? "text-[#2D7A4F]" : "text-[#3A2E28]",
                ].join(" ")}
              >
                {fmt(value, currency)}
              </p>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12">
        <div className="grid gap-6 lg:grid-cols-5">
          {/* Left 60%: spending breakdown */}
          <div className="lg:col-span-3 space-y-6">
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-base font-bold text-[#3A2E28]">
                Spending breakdown
              </h2>
                ...
                <ul className="divide-y divide-[#3A2E28]/5">
                  {expenses.map((e) => (
                    <li key={e.id} className="flex items-center justify-between py-2.5">
                      ...
                      <span className="text-sm font-bold text-[#3A2E28] tabular-nums">
          ...
          {/* Right 40%: income summary + upcoming bills */}
                ...
                <div className="mt-3 flex items-center justify-between border-t border-[#3A2E28]/10 pt-3 text-sm">
                  ...
                  <dd
                    className={[
                      ...
                      disposablePositive ? "text-[#2D7A4F]" : "text-[#F4633A]",
                    ].join(" ")}
                  >
                    {fmt(totals.disposable, currency)}
                  </dd>
